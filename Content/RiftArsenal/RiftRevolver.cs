...
{
	public class RiftRevolver : ModItem
	{
		...
		public override void AddRecipes() {
			CreateRecipe()
                .AddCondition(Language.GetText("Mods.DestroyerTest.RecipeCondition.Charge"), () => Main.LocalPlayer.HasItem(ModContent.ItemType<Husk_RiftRevolver>()))
				.Register();
		}
		...
		*/
        ...
        private void NoChargeLeft(Player player)
        {
			...
			{
            hasReplaced = true;
			Item.NewItem(player.GetSource_FromThis(), player.position, ModContent.ItemType<Husk_RiftRevolver>());
            Item.TurnToAir();
            }
        }
