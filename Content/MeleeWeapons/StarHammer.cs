...
namespace DestroyerTest.Content.MeleeWeapons
{
    ...
    public class StarHammer : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<StarHammerSwing>(); // The sword as a projectile
        }
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            attackType = (attackType + 1) % 4; // Increment attackType to cycle through three attack types
        ...
        {
            if (comboExpireTimer++ >= 240) // after 120 ticks (== 2 seconds) in inventory, reset the attack pattern
                attackType = 0;
        }
